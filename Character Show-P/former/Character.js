...
function Character(info) {
	...
	// this를 쓴건 : 캐릭터 생성자를 통해서 만들어낼 인스턴스 객채의 속성으로 쓰겠다.
	// 메소드에서의 this는 메소드를 호출한 객체가
	// 생성자함수: 새로운 객체를 생성했을 경우 생성자 함수 내의 this 는 new 를 통해 만들어진 새로운 변수가 됩니다.
